...
{
    public class Apt1JamesJoyceEmail
    {
        ...
        <body>
            ...
            <p><strong>Fáilte (Welcome)!</strong> If you need anything before, during, or after your stay, please feel free to reach me at <a href='mailto:info@arasdestaic.com'>info@arasdestaic.com</a>. You can also contact us through the website live chat if you prefer.</p>
            ...
            <h3>Parking</h3>
            <p>While there is free street parking, please respect local residents and use the free parking lot across the street, just beside the church. Here is a pin to the carpark: <a href='{parkingLink}'>Parking Location</a>.</p>
            <p>There are also paid parking options around town.</p>

            <h3>Amenities</h3>
            <ul>
                <li><strong>Kitchen Items:</strong> Dishes, glasses, and cups are in the upper cabinets. Silverware is in the drawer. Cooking utensils are in the bottom cabinet. Feel free to use any of these.</li>
