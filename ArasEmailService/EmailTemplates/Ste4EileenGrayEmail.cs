...
{
    public class Ste4EileenGrayEmail
    {
        public static string Instructions (JToken booking)
        {
            return $@"
            <h3>Ste. 4: Eileen Gray</h3>
            <p>Please enter through the <span style='color:purple'>PURPLE</span> front door with keypad code <strong>0669</strong>. 
            Your suite is up the stairs on the 1st floor. The key lockbox code is <strong>0421</strong>. Please scramble the code after retrieving keys, and after leaving. 
            Thank you!</p>
