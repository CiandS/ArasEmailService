    ...
    public class Ste6SamuelBeckettEmail
    {
        public static string Instructions (JToken booking)
        {
            ...
            <ol>
                ...
                <li>Use keypad code <strong>0669</strong> for the front door and lockbox code <strong>0621</strong> to retrieve your keys.</li>
                <li>Your suite is located <strong>up the stairs on the 2nd floor</strong>.</li>
